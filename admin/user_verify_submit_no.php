...
if(isset($_POST['submitVerifyNo']) && isset($_POST['uid']) && isset($_POST['uts']))
{
	$uid = $_POST['uid'];
	$uts = $_POST['uts'];
}
...
Are you sure you want to deny this user ?<br><?php echo $uid; ?><br><br>
<input type=submit name='submitConfirm' value='DENY USER'>
