<!--Choose Section-->
<section class="choose-sectionXXX" style='padding-top:60px; padding-bottom:60px; background-color:#DDD;'>
	<div class="auto-container">
		...
		<div class="row clearfix">
			...
			<script src="files/jssor-slider/jssor.slider-28.1.0.min.js" type="text/javascript"></script>
			...
			<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:380px;overflow:hidden;visibility:hidden;">
				...
				<div data-u="loading" class="jssorl-009-spin" style="position:absolute;top:0px;left:0px;width:100%;height:100%;text-align:center;background-color:rgba(0,0,0,0.7);">
					<img style="margin-top:-19px;position:relative;top:50%;width:38px;height:38px;" src="files/jssor-slider/spin.svg" />
				</div>
				<div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
					<?php
					$sql = "select * from `$db`.`mt_ads` where status='y' order by rand() limit 0,10;";
					...
					while($row = mysqli_fetch_array($result))
					{
						...
						?>
						<div data-idle="10000">
							<img data-u="image" src="files/jssor-slider/<?php echo $ad_id; ?>.jpg" />
							<div u="thumb"><?php echo $ad_cap; ?></div>
						</div>
						<?php
					}
					?>
