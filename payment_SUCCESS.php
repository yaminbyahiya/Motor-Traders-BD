...
if(isset($_REQUEST['invid']) && isset($_REQUEST['tid']) && isset($_REQUEST['uid']))
{
	...
	while($row = mysqli_fetch_array($r, MYSQLI_BOTH))
	{
		...
		elseif($txntype=="mtrpt") {
			...
			$path = "downloads/mt-report/".$pid;
			$mfile = $path."/mt_report.".$fileExt;
...
*/
			...
			//require('emails/mt-report-email.php');
			//require('emails/mt-report-mail.php');
			require('emails/mt-report-mail-link.php');
		}
