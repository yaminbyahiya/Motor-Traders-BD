...
if($email!="")
{
	...
	$to = "$email";
	$subject = "Your post has been approved now for public visitors";
	$msg = "
	Hi $name,<br>
	<br>
	Your post/blog has been approved! You can find your content on the Motor Trader platform now.<br>
	<a target='_blank' href='https://motortraderbd.com/vehicle_details.php?pid=$pid'>Click here to view your post.</a><br>
	<br>
	Have a great day!<br>
	<br>
	Kind regards,<br>
